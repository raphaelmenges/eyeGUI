...
namespace eyegui
{
    ...
    COLOR, CIRCLE, DIM, ACTIVITY, MARK, CIRCLE_THRESHOLD, BOX_THRESHOLD, HIGHLIGHT, SELECTION, CIRCLE_BUTTON, BOX_BUTTON, SENSOR, TEXT,
    IMAGE, KEY, CHARACTER_KEY}; } // TODO: To be deleted
