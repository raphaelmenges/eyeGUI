...
namespace eyegui
{
    ...
    COLOR, CIRCLE, DIM, ACTIVITY, MARK, CIRCLE_THRESHOLD, BOX_THRESHOLD, HIGHLIGHT, SELECTION, CIRCLE_BUTTON, BOX_BUTTON,
    SEPARATOR, BLOCK, IMAGE, SENSOR, TEXT, KEY, CHARACTER_KEY}; } // TODO: To be deleted
