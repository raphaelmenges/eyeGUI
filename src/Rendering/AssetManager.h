...
namespace eyegui
{
    ...
    COLOR, CIRCLE, DIM, ACTIVITY, MARK, CIRCLE_THRESHOLD, BOX_THRESHOLD, HIGHLIGHT, SELECTION, BOX_BUTTON,
    SEPARATOR, BLOCK, IMAGE, CIRCLE_BUTTON, SENSOR, TEXT, KEY, CHARACTER_KEY}; } // TODO: To be deleted
