...
namespace eyegui
{
    ...
    float Button::specialUpdate(float tpf, Input* pInput)
    {
        ...
        {
            mPressing.update(tpf / mpLayout->getConfig()->getValue(StyleType_float::ButtonPressingDuration)->get());
        }
        ...
        {
            mThreshold.update(tpf / mpLayout->getConfig()->getValue(StyleType_float::ButtonThresholdIncreaseDuration)->get());
        ...
        {
            mThreshold.update(-tpf / mpLayout->getConfig()->getValue(StyleType_float::ButtonThresholdDecreaseDuration)->get());
        }
