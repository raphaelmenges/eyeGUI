...
namespace eyegui
{
    ...
    std::unique_ptr<elementsAndIds> ElementParser::parse(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, tinyxml2::XMLElement const * xmlElement, Element* pParent, std::string filepath) const
    {
        // Create map for ids
    ...
    std::unique_ptr<Element> ElementParser::parseElement(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, tinyxml2::XMLElement const * xmlElement, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
    ...
    std::unique_ptr<Grid> ElementParser::parseGrid(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlGrid, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
        // Get first row
    ...
    std::unique_ptr<Blank> ElementParser::parseBlank(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlBlank, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
    ...
    std::unique_ptr<Block> ElementParser::parseBlock(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlBlock, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
    ...
    std::unique_ptr<Picture> ElementParser::parsePicture(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlPicture, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
    ...
    std::unique_ptr<Stack> ElementParser::parseStack(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlStack, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
        // Get inner border
    ...
    std::unique_ptr<BoxButton> ElementParser::parseBoxButton(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlBoxButton, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
        // Extract filepath
    ...
    std::unique_ptr<Sensor> ElementParser::parseSensor(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlSensor, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
        // Extract filepath
    ...
    std::unique_ptr<DropButton> ElementParser::parseDropButton(Layout* pLayout, Frame* pFrame, AssetManager* pAssetManager, std::string id, std::string styleName, float relativeScale, float border, tinyxml2::XMLElement const * xmlDropButton, Element* pParent, std::string filepath, idMap& rIdMap) const
    {
        // Extract filepath
