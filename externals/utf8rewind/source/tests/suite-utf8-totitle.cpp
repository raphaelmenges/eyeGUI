...
TEST_F(Utf8ToTitle, BasicLatinSentencePunctuationAtStart)
{
	...
	EXPECT_EQ(17, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, BasicLatinSentencePunctuationAtEnd)
{
	...
	EXPECT_EQ(14, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, GeneralCategoryCaseMappedSentence)
{
	...
	EXPECT_EQ(31, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, GraphemeClusterSingleUppercase)
{
	// 024E 1DCE 065C
	//    0  214  220
...
TEST_F(Utf8ToTitle, GraphemeClusterSingleLowercase)
{
	// 0242 0F71 0328 0F39
	//    0  129  202  216
...
TEST_F(Utf8ToTitle, GraphemeClusterSingleTitlecase)
{
...
TEST_F(Utf8ToTitle, GraphemeClusterSingleUnaffected)
{
...
TEST_F(Utf8ToTitle, GraphemeClusterMultipleUppercase)
{
...
TEST_F(Utf8ToTitle, GraphemeClusterMultipleLowercase)
{
	...
	EXPECT_EQ(41, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, GraphemeClusterMultipleTitlecase)
{
	...
	EXPECT_EQ(29, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, GraphemeClusterMultipleUnaffected)
{
...
TEST_F(Utf8ToTitle, GraphemeClusterSentence)
{
	...
	EXPECT_EQ(63, utf8totitle(c, strlen(c), b, s, &errors));
...
TEST_F(Utf8ToTitle, GraphemeClusterAmountOfBytes)
{
	// 03B0 0344 0312
	//    0  230  230
...
TEST_F(Utf8ToTitle, GraphemeClusterNotEnoughSpace)
{
	// 0390 1DCE 1CED
	//    0  214  220
