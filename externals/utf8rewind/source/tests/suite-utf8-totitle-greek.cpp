...
TEST_F(Utf8ToTitleGreek, SingleCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xA3";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SingleCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xA3";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, SingleSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x83";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SingleSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCF\x83";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, SingleSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x82";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SingleSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCF\x82";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, WordCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xAB\xCE\xA3\xCE\x9E\xCE\x9A";
	const size_t s = 5;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, WordCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xAB\xCE\xA3\xCE\x9E\xCE\x9A";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, WordCapitalLetterSigmaAtEndNotEnoughSpace)
{
	const char* c = "\xCE\xA3\xCE\x9F\xCE\x99\xCE\xA3";
	const size_t s = 6;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, WordCapitalLetterSigmaAtEndAmountOfBytes)
{
	const char* c = "\xCE\xA3\xCE\x9F\xCE\x99\xCE\xA3";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, WordSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xB5\xCE\xBB\xCF\x80\xCF\x83";
	const size_t s = 5;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, WordSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xB5\xCE\xBB\xCF\x80\xCF\x83";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, WordSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xBE\xCE\xB2\xCE\x9F\xCE\xAC\xCF\x82";
	const size_t s = 4;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, WordSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCE\xBE\xCE\xB2\xCE\x9F\xCE\xAC\xCF\x82";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, SentenceCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xA3\xCE\xA3\xCE\xA3 \xCF\x8D\xCF\x84";
	const size_t s = 4;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SentenceCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xA3\xCE\xA3\xCE\xA3 \xCF\x8D\xCF\x84";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToTitleGreek, SentenceSmallLetterSigma)
{
	...
	EXPECT_EQ(20, utf8totitle(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCE\xA1\xCE\xBC\xCE\xBE\xCF\x83 \xCE\xA1\xCF\x83\xCF\x86 \xCE\x99\xCE\xB1", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8ToTitleGreek, SentenceSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x81\xCE\xBC\xCE\xBE\xCF\x83 \xCF\x81\xCF\x83\xCF\x86 \xCE\xB9\xCE\xB1";
	const size_t s = 7;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SentenceSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCF\x81\xCE\xBC\xCE\xBE\xCF\x83 \xCF\x81\xCF\x83\xCF\x86 \xCE\xB9\xCE\xB1";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(20, utf8totitle(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToTitleGreek, SentenceSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xB8\xCF\x82 \xCE\xB4\xCF\x88\xCE\xB7";
	const size_t s = 6;
	char b[256] = { 0 };
...
TEST_F(Utf8ToTitleGreek, SentenceSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCE\xB8\xCF\x82 \xCE\xB4\xCF\x88\xCE\xB7";
	int32_t errors = UTF8_ERR_NONE;
