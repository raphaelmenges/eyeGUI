...
TEST_F(Utf8ToLowerGreek, SingleCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xA3";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToLowerGreek, SingleCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xA3";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToLowerGreek, SingleSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x82";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToLowerGreek, SingleSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCF\x82";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToLowerGreek, WordCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xBC\xCE\xBE\xCE\xA3\xCE\x9F";
	const size_t s = 4;
	char b[256] = { 0 };
...
TEST_F(Utf8ToLowerGreek, WordCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xBC\xCE\xBE\xCE\xA3\xCE\x9F";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToLowerGreek, WordSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xBB\xCE\xBD\xCF\x83\xCF\x8D";
	const size_t s = 3;
	char b[256] = { 0 };
...
TEST_F(Utf8ToLowerGreek, WordSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xBB\xCE\xBD\xCF\x83\xCF\x8D";
	int32_t errors = UTF8_ERR_NONE;
