...
TEST_F(Utf8ToUpperGreek, SingleCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xA3";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, SingleCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\xA3";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToUpperGreek, SingleSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x83";
	const size_t s = 0;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, SingleSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCF\x83";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToUpperGreek, SingleSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x82";
	const size_t s = 1;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, SingleSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCF\x82";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToUpperGreek, WordCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\x99\xCE\xA3\xCE\xB7\xCE\xA6";
	const size_t s = 5;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, WordCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\x99\xCE\xA3\xCE\xB7\xCE\xA6";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(8, utf8toupper(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToUpperGreek, WordCapitalLetterSigmaAtEndNotEnoughSpace)
{
	const char* c = "\xCE\x96\xCE\xA0\xCE\xA4\xCE\xA3";
	const size_t s = 7;
	char b[256] = { 0 };
	...
	EXPECT_EQ(6, utf8toupper(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCE\x96\xCE\xA0\xCE\xA4", b);
	EXPECT_ERROREQ(UTF8_ERR_NOT_ENOUGH_SPACE, errors);
}

TEST_F(Utf8ToUpperGreek, WordCapitalLetterSigmaAtEndAmountOfBytes)
{
	const char* c = "\xCE\x96\xCE\xA0\xCE\xA4\xCE\xA3";
	int32_t errors = UTF8_ERR_NONE;
...
TEST_F(Utf8ToUpperGreek, WordSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x85\xCE\xBD\xCE\xB6\xCE\xB6\xCF\x83";
	const size_t s = 5;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, WordSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCF\x85\xCE\xBD\xCE\xB6\xCE\xB6\xCF\x83";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(10, utf8toupper(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToUpperGreek, WordSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCE\xB6\xCE\xB3\xCF\x82";
	const size_t s = 3;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, WordSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCE\xB6\xCE\xB3\xCF\x82";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(6, utf8toupper(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToUpperGreek, SentenceCapitalLetterSigma)
{
	...
	EXPECT_EQ(13, utf8toupper(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCE\x99\xCE\x99\xCE\xA3 \xCE\x94\xCE\xA0\xCE\xAB", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8ToUpperGreek, SentenceCapitalLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\x99\xCE\x99\xCE\xA3 \xCE\x94\xCE\xA0\xCE\xAB";
	const size_t s = 7;
	char b[256] = { 0 };
	...
	EXPECT_EQ(7, utf8toupper(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCE\x99\xCE\x99\xCE\xA3 ", b);
	EXPECT_ERROREQ(UTF8_ERR_NOT_ENOUGH_SPACE, errors);
}

TEST_F(Utf8ToUpperGreek, SentenceCapitalLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\x99\xCE\x99\xCE\xA3 \xCE\x94\xCE\xA0\xCE\xAB";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(13, utf8toupper(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToUpperGreek, SentenceSmallLetterSigma)
{
	...
	EXPECT_EQ(17, utf8toupper(c, strlen(c), b, s, &errors));
	EXPECT_UTF8EQ("\xCE\x97\xCE\xA3\xCE\xA7\xCE\x9F\xCE\xA3 \xCE\x98\xCE\xA3\xCE\xA6", b);
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}

TEST_F(Utf8ToUpperGreek, SentenceSmallLetterSigmaNotEnoughSpace)
{
	const char* c = "\xCE\x97\xCE\xA3\xCE\xA7\xCE\xBF\xCF\x83 \xCE\xB8\xCF\x83\xCF\x86";
	const size_t s = 8;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, SentenceSmallLetterSigmaAmountOfBytes)
{
	const char* c = "\xCE\x97\xCE\xA3\xCE\xA7\xCE\xBF\xCF\x83 \xCE\xB8\xCF\x83\xCF\x86";
	int32_t errors = UTF8_ERR_NONE;

	EXPECT_EQ(17, utf8toupper(c, strlen(c), nullptr, 0, &errors));
	EXPECT_ERROREQ(UTF8_ERR_NONE, errors);
}
...
TEST_F(Utf8ToUpperGreek, SentenceSmallLetterFinalSigmaNotEnoughSpace)
{
	const char* c = "\xCF\x83\xCF\x82 \xCE\xBA\xCE\xB7\xCF\x8B\xCF\x8B";
	const size_t s = 12;
	char b[256] = { 0 };
...
TEST_F(Utf8ToUpperGreek, SentenceSmallLetterFinalSigmaAmountOfBytes)
{
	const char* c = "\xCF\x83\xCF\x82 \xCE\xBA\xCE\xB7\xCF\x8B\xCF\x8B";
	int32_t errors = UTF8_ERR_NONE;
